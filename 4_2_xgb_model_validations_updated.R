...
out_path <- "/Volumes/NYC_geo/tree_classification/outputs_practical_v2_1_monthcomp"
name_prefix <- "practical_v2_1_monthcomp_"

tree_df_for_cls_clean <- readRDS("/Volumes/NYC_geo/tree_classification/cls_prepped_file_v2_1_monthcomp.rds")
